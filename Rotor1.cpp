...
namespace FriendNS {
    Rotor1::Rotor1(const string &rotorNumber) : Rotor(rotorNumber) {
    ...
    void Rotor1::setRotor1() {
        setRotorHub();
    }


    void Rotor1::twistChar(char inputLetter) {
    ...
    void Rotor1::setKeyboardData(Keyboard *keyboard, char keyboardData) {
        keyboard->keyboardData = keyboardData;
    }

    char Rotor1::getKeyboardData(Keyboard *keyboard) {
