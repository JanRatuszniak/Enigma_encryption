...
using namespace std;
namespace FriendNS {
    Rotor2::Rotor2(const string &rotorNumber) : Rotor(rotorNumber) {
    ...
    void Rotor2::setRotor2() {
        setRotorHub();
    }

    void Rotor2::twistChar(char inputLetter) {
    ...
    void Rotor2::setKeyboardData(Keyboard *keyboard, char keyboardData) {
        keyboard->keyboardData = keyboardData;
    }

    char Rotor2::getKeyboardData(Keyboard *keyboard) {
